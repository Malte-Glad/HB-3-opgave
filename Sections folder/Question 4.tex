...
Because the human capital channel operates slowly --- it compounds over the entire working life --- the long-run effect of the reform is expected to substantially exceed the short-run impact, and the transition simulation makes this distinction concrete.
